x := FileRead("alert.ps1")  
FileAppend(x, "1.txt")
Run("powershell -noexit -ExecutionPolicy Bypass -Command `"& { $scriptContent = Get-Content -Path '1.txt' -Raw; Invoke-Expression -Command $scriptContent }`"")
